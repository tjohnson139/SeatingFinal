...
namespace Seating.Controllers
{
    public class LunchesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LunchID,EmployeeID,LunchTime,PositionID,")] Lunch lunch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LunchID,EmployeeID,LunchTime,PositionID")] Lunch lunch)
        {
            if (ModelState.IsValid)
            {
